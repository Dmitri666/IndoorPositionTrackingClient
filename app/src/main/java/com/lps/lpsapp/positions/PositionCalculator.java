...
//    public static void setRoomModel(RoomModel room)
//    {
//        beaconsInRoom.clear();
//        for(BeaconInRoom beacon:room.beacons)
//        {
//            beaconsInRoom.put(beacon.id3,beacon);
//        }
//        mRoomHeight = room.height;
//        mRoomWigth = room.wight;
//    }

    public static PointD calculatePosition(Collection<Beacon> beacons)
    {
